  ...
  export default CustomDialog.extend({
    ...
    methods: {
      async load(): Promise<void> {
        ...
        // Desktop-only: lists user-installed character-page theme CSS files
        // from disk. Not ported to mobile (would need a Capacitor
        // Filesystem-based picker/import flow) — fs is stubbed to throw
        // here, so this degrades to "no custom character themes available"
